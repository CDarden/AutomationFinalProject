...
WebDriver driver;
	...
	//Element Library
		@FindBy(how = How.XPATH, using = "//select[@name = 'due_month']") WebElement DUE_MONTH_LOCATOR;
		@FindBy(how = How.XPATH, using = "//*[@id=\"extra\"]/select[3]/option[2]") WebElement JAN_MONTH_LOCATOR;
		@FindBy(how = How.XPATH, using = "//*[@id=\"extra\"]/select[3]/option[3]") WebElement FEB_MONTH_LOCATOR;
		@FindBy(how = How.XPATH, using = "//*[@id=\"extra\"]/select[3]/option[4]") WebElement MARCH_MONTH_LOCATOR;
	
	// Interactive Methods
		
		public void clickOnDueMonth() {
			waitforElement(driver, 20, DUE_MONTH_LOCATOR);
			DUE_MONTH_LOCATOR.click();
		}
		...
		public void selectSecondMonth(String month2) {
			selectDropDown(JAN_MONTH_LOCATOR, month2);
		}
		
		public void selectThirdMonth(String month3) {
			selectDropDown(JAN_MONTH_LOCATOR, month3);
		}
